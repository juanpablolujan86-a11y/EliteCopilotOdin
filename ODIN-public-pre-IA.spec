...
a = Analysis(
    ...
    datas=[
        ...
        (str(root / "docs" / "DISCORD_BETA_PRE_IA.md"), "docs"),
    ],
    hiddenimports=["tkinter", "tkinter.ttk"],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[str(root / "installer" / "runtime_public_no_ai.py")],
...
exe = EXE(
    pyz, a.scripts, [], exclude_binaries=True, name="ODIN",
    debug=False, bootloader_ignore_signals=False, strip=False, upx=True,
    console=False, icon=str(root / "assets" / "odin_raven.ico"),
    disable_windowed_traceback=False,
)

coll = COLLECT(
    exe, a.binaries, a.datas, strip=False, upx=True,
    upx_exclude=[], name="ODIN-public-pre-IA",
)
